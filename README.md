...
通过浏览目录，就知道我选择了一些什么内容。初级我选择了三组共四个概念，中高级介绍了单元测试和DSL。这些内容， 特别是初级部分，是我根据我的自学经验，认为对初学者比较重要的核心的内容，不是说别的Array、Hash等不重要，只是为了简明和快速学习，做了取舍。
...
类似的书一般都涉及很多细节，反而让主干不清晰，初学者往往不得要领，学习负担重。如果一开始读到本书这样的介绍，我认为是有帮助的。即使是从未写过程序的人来学，我相信初级部分一天就能学完。
...
1. 先学习初初级部分
2. 有兴趣继续的话学中级, 由于本书没有涉及细节，中级部分需要一本参考书,可自选书籍或者参考这个电子版[基础教程](http://blog.51yip.com/manual/ruby/)。
